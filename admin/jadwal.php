								...
								<table id="zctb" class="display table table-striped table-bordered table-hover" cellspacing="0" width="100%">
									...
									<?php
										...
										<tr align="center">
											...
											<td>
											<a href="jadwal_selesai.php?id=<?php echo $result['id_trx'];?>" onclick="return confirm('Apakah anda yakin akan menyelesaikan transaksi <?php echo $result['id_trx'];?>?');" class="btn btn-primary btn-xs">Selesai</a></td>
										</tr>
										<?php }?>
									</tbody>
								</table>

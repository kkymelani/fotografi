	<nav class="ts-sidebar">
			<ul class="ts-sidebar-menu">			
				...
				<li><a href="jadwal.php"><i class="fa fa-calendar"></i>Jadwal Pemotretan</a></li>
				<li><a href="paket.php"><i class="fa fa-book"></i>Package</a></li>
				<li><a href="reg-users.php"><i class="fa fa-users"></i> Member</a></li>
				<li><a href="manage-pages.php"><i class="fa fa-gear"></i>Manage Page</a></li>

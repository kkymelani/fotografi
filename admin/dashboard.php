								...
								<div class="row">
									...
									<div class="col-md-4">
										<div class="panel panel-default">
											...
											<a href="trx_bayar.php" class="block-anchor panel-footer text-center">Detail &nbsp; <i class="fa fa-arrow-right"></i></a>
										</div>
									</div>
									...
									<div class="col-md-4">
										<div class="panel panel-default">
											...
											<a href="trx_konfirmasi.php" class="block-anchor panel-footer text-center">Detail &nbsp; <i class="fa fa-arrow-right"></i></a>
										</div>
									</div>
									...
									<div class="col-md-4">
										<div class="panel panel-default">
											...
											<a href="jadwal.php" class="block-anchor panel-footer text-center">Detail &nbsp; <i class="fa fa-arrow-right"></i></a>
										</div>
									</div>
								</div>
							</div>
